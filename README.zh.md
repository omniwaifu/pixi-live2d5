...
这个仓库是原始 `pixi-live2d-display` 项目的 `omniwaifu/pixi-live2d5` fork。公开包名仍然是
`pixi-live2d-display`，但由于 Cubism framework 作为 git submodule 管理，这个源码仓库更适合通过本地 checkout 使用。
